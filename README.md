...
an explicit host-opened root. Its exact feature-branch review, CI, and benchmark
evidence are green; the final documentation seal and `main` integration remain
