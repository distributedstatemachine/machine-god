...
- Next gate: `wire parent enrollment, relationship approvals and managed navigation into the native host and thin CLI; then run the complete feature gate and three fresh reviews`
