...
- Active phase: `vision replacement local gate is green; adversarial review cycle 2 is next`
- Next gate: `obtain zero findings from three fresh adversarial product-review tracks`
