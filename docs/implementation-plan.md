...
- Next gate: `fix R11 event-history error reporting, validate regressions, then complete replacement local gates and three fresh whole-feature reviews; retain unresolved macOS failure evidence`
