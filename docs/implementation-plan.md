...
- Next gate: `wire managed foreground transitions and Agents & processes navigation into the native interactive owner and thin CLI; then run the complete feature gate and three fresh reviews`
