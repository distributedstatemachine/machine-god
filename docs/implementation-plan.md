...
- Next gate: `verify managed one-shot and ACP ownership integration; complete multi-owner navigation and production ACP assembly; then run the complete feature gate and three fresh reviews`
