...
- Next gate: `complete the replacement Linux/macOS local gate for the R14 replay-fairness repair, then three fresh whole-feature reviews and exact feature/main artifact gates`
