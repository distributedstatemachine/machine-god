...
- Next gate: `verify managed CLI startup and prompt custody; complete multi-owner navigation and all-host tool integration; then run the complete feature gate and three fresh reviews`
