...
- Next gate: `verify ACP host reuse and process navigation; finish independent child drafts/history and local model/skill navigation; then run the complete feature gate and three fresh reviews`
