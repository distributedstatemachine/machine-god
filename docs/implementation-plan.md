...
- Next gate: `fix three R10 findings, validate regressions, then complete replacement local gates and three fresh whole-feature reviews; retain unresolved macOS failure evidence`
