...
- Next gate: `verify the catalog selection acknowledgement repair and all review/platform corrections with focused and complete Linux/macOS gates, then three fresh whole-feature reviews`
