...
- Active phase: `vision adversarial review cycle 4 rejected; remediation is in progress`
- Next gate: `fix all cycle-4 findings, rerun the complete gate, and restart three fresh reviews`
