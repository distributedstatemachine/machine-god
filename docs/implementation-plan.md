...
- Next gate: `verify child-local model selection and restored skill invocation; finish child-local skill navigation; then run the complete feature gate and three fresh reviews`
