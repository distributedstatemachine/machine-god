...
- Next gate: `complete full Linux/macOS feature gates, then three fresh whole-feature reviews; managed release-CLI restart and composed PTY conversation scenarios pass`
