...
- Active phase: `vision adversarial review cycle 12 rejected; remediation is in progress`
- Next gate: `fix all cycle-12 findings, rerun the complete gate, and restart three fresh reviews`
