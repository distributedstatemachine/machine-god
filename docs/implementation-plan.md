...
- Next gate: `verify macOS shared-TTY write-history fix with fresh release CLI, rerun complete Linux/macOS feature gates, then three fresh whole-feature reviews`
