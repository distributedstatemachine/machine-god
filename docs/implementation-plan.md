...
- Active phase: `vision adversarial review cycle 8 rejected; remediation is in progress`
- Next gate: `fix all cycle-8 findings, rerun the complete gate, and restart three fresh reviews`
