...
- Active phase: `bounded top-level ask CLI cycle-2 findings are remediated and focused-test green`
- Next gate: `pass the complete exact-1.94.1 replacement gate on one frozen candidate, then restart all three adversarial review tracks`
