...
- Next gate: `validate helper-startup diagnostics, complete replacement local gates and three fresh whole-feature reviews; retain unresolved macOS failure evidence`
