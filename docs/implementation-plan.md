...
- Next gate: `verify managed startup, candidate headroom and transition cleanup; finish multi-owner navigation and thin CLI integration; then run the complete feature gate and three fresh reviews`
