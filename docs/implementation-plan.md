...
- Next gate: `verify production ACP host reuse and owner-scoped process navigation; finish multi-owner CLI navigation; then run the complete feature gate and three fresh reviews`
