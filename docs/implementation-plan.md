...
- Active phase: `remediating the first M03 help/status adversarial-review cycle`
- Next gate: `run the complete replacement local gate, then three fresh reviews on one exact SHA`
