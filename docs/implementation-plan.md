...
- Next gate: `fix R12 journal accounting scalability and shipped-host reconciliation recovery, validate regressions, then complete replacement local gates and three fresh whole-feature reviews; retain unresolved macOS failure evidence`
