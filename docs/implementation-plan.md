...
- Next gate: `verify native form and CLI integration; complete multi-owner navigation and production ACP assembly; then run the complete feature gate and three fresh reviews`
