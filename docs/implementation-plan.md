...
- Next gate: `complete the replacement Linux/macOS local gate for the R13 frozen-work resume repair, then three fresh whole-feature reviews and exact feature/main artifact gates`
