...
- Next gate: `verify complete child-local model/skill navigation and post-mutation observations; then run the complete feature gate and three fresh reviews`
