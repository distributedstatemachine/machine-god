...
- Next gate: `verify serialized canonical history reads and full-detail navigation; finish child-local model/skill navigation; then run the complete feature gate and three fresh reviews`
