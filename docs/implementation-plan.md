...
- Active phase: `vision adversarial review cycle 3 rejected; remediation is in progress`
- Next gate: `fix all cycle-3 findings, rerun the complete gate, and restart three fresh reviews`
