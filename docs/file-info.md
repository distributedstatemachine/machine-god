...
`5c2d129a3755dca0c8f7913b27614b70352fe2a4` and production-only composed SHA
`1d93a65`; independent tests, three fresh adversarial review tracks, and exact
feature and `main` delivery workflows remain pending. `file_info` is a library
