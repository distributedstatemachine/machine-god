...
- [Cycle-4-rejected, cycle-5-pre-gate top-level `models` CLI contract](models-cli.md)
...
- [Milestone 03 `models` CLI cycle-4 rejection and remediation ledger](reviews/m03-models-cli-review-01.md)
