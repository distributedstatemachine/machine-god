...
- [Native interactive byte input](interactive-input.md)
...
- Workspace-local instruction resources: [skill](skill.md) and bounded local
...
- Injected MCP discovery, selection, resources, and prompts:
...
- Native MCP building blocks: [command/configuration parsing](mcp-cli.md),
  ...
  [owned startup batches](mcp-startup.md),
  ...
  and [tool results](mcp-tool-results.md), with [archived execution](mcp-tool-execution.md).
