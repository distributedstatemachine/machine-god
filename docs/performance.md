...
| [vision](vision.md) | 20 sources, 4 KiB focus, 8 MiB per image, 64 MiB aggregate reads/admission plus one growth witness, 12-byte invalid-signature probe, sequential batches of 8 images/8 MiB, 20 KiB evidence per attempt, 64 KiB response, 48 KiB projected result, 60-second total deadline, default 2/hard 8 active calls |
