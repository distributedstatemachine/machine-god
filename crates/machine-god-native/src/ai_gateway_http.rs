...
/// Stable construction-error category for the native HTTP transport.
...
/// Redacted HTTP-transport construction failure.
...
impl AiGatewayHttpConfigError {
    ...
    const fn new(kind: AiGatewayHttpConfigErrorKind) -> Self {
        Self { kind }
    }
}
