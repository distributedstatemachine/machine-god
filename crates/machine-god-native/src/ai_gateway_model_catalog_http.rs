...
use crate::bounded_dns::{
    ParsedSystemResolverSnapshot, QueryIdSequence, SYSTEM_RESOLVER_MAX_DNS_ADDRESSES,
    SystemDnsAnswer, SystemDnsServerError, SystemResolverConfigurationUnavailable,
    SystemResolverSnapshot, advance_system_cname_chain, load_system_resolver_snapshot,
    query_system_name_server, system_dns_query, validate_system_resolver_snapshot,
};
use crate::{
...
use hickory_proto::rr::{Name as DnsName, RecordType};
...
mod tests {
    ...
    use hickory_proto::rr::{RData, Record, rdata::CNAME};
